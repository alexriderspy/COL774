...
######################################STANDARD CLASSIFIER###############################################
    ...
    fig.savefig(output_path + '/q1.1a.png')
...
####################GRID SEARCH ##########################################################
    ...
    parameters = {'max_depth':[3, 5,6,7,8,14], 'min_samples_split': [4,5,6,9,10], 'min_samples_leaf': [4,5,6,9,10]}
    ...
    fig.savefig(output_path + '/q1.1b.png')
...
###################################CCP ALPHA PART###################################################
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/q1.1c.png')
    ...
    parameters = {'max_features': [2,3,4], 'min_samples_split': [5,6,7,8,9], 'n_estimators': [90,100,110,120], 'oob_score': [True]}
...
############################IMPUTER STRATEGY IS MEAN ###########################################
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/mean_e_q1.1a.png')
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(tree_clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/mean_e_q1.1b.png')
    ...
    ax.set_ylabel("total impurity of leaves")
    ax.set_title("Total Impurity vs effective alpha for training set")
    fig.savefig(output_path + '/mean_e_Total Impurity vs effective alpha for training set.png')
    ...
    ax[1].set_title("Depth vs alpha")
    fig.tight_layout()
    fig.savefig(output_path + '/mean_e_Depth vs alpha.png')
    ...
    ax.plot(ccp_alphas, test_scores, marker="o", label="test", drawstyle="steps-post")
    ax.legend()
    fig.savefig(output_path + '/mean_e_accuracy vs alpha.png')
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/mean_e_q1.1c.png')
...
####################################################### MEDIAN###########################
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/median_e_q1.1a.png')
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(tree_clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/median_e_q1.1b.png')
    ...
    ax.set_ylabel("total impurity of leaves")
    ax.set_title("Total Impurity vs effective alpha for training set")
    fig.savefig(output_path + '/median_e_Total Impurity vs effective alpha for training set.png')
    ...
    ax[1].set_title("Depth vs alpha")
    fig.tight_layout()
    fig.savefig(output_path + '/median_e_Depth vs alpha.png')
    ...
    ax.plot(ccp_alphas, test_scores, marker="o", label="test", drawstyle="steps-post")
    ax.legend()
    fig.savefig(output_path + '/median_e_accuracy vs alpha.png')
    ...
    fig, axes = plt.subplots(nrows = 1,ncols = 1,figsize = (10,10), dpi=600)
    tree.plot_tree(clf,feature_names = features, class_names = class_names, filled=True, rounded = True)
    fig.savefig(output_path + '/median_e_q1.1c.png')
